...
/**
 * @author Michael B Provides input from a file for use in a game storage hash table
 */
public class DataCollector {
  ...
  /**
   * Creates a DataCollector object that reads in data from input and creates the following Game and
   * User objects to be stored in an Array
   * 
